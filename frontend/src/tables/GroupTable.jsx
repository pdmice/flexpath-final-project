...
export default function GroupTable({groupID}){
       ...
       useEffect(() => {
        ...
        return(
            ...
            <div className="container-md">
                ...
                <Table data={data} setData={setData} loading={loading} errorState={errorState} path={location.pathname} modifiable={true} groupID={groupID}/>
            </div>
